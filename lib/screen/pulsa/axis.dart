...
class Axxis extends StatefulWidget {
  const Axxis({Key? key}) : super(key: key);

  @override
  State<Axxis> createState() => _AxxisStateState();
}

class _AxxisStateState extends State<Axxis> {
                ...
                children: <Widget>[
                  Card(
                    ...
                    child: Column(
                      children: <Widget>[
                        ListTile(
                          title: const Text("Pulsa Reguler Axis 1.000"),
                          trailing: Column(
                            children: <Widget>[
                              //Text('Test'),
                              ElevatedButton(
                        ...
                        _buildDivider(),
                        ListTile(
                          title: const Text("Pulsa Reguler Axis 2.000"),
                          trailing: Column(
                            children: <Widget>[
                              //Text('Test'),
                              ElevatedButton(
                        ...
                        _buildDivider(),
                        ListTile(
                          title: const Text("Pulsa Reguler Axis 3.000"),
                          trailing: Column(
                            children: <Widget>[
                              //Text('Test'),
                              ElevatedButton(
                        ...
                        _buildDivider(),
                        ListTile(
                          title: const Text("Pulsa Reguler Axis 4.000"),
                          trailing: Column(
                            children: <Widget>[
                              //Text('Test'),
                              ElevatedButton(
                        ...
                        _buildDivider(),
                        ListTile(
                          title: const Text("Pulsa Reguler Axis 5.000"),
                          trailing: Column(
                            children: <Widget>[
                              //Text('Test'),
                              ElevatedButton(
                        ...
                        _buildDivider(),
                        ListTile(
                          title: const Text("Pulsa Reguler Axis 10.000"),
                          trailing: Column(
                            children: <Widget>[
                              //Text('Test'),
                              ElevatedButton(
                        ...
                        _buildDivider(),
                        ListTile(
                          title: const Text("Pulsa Reguler Axis 15.000"),
                          trailing: Column(
                            children: <Widget>[
                              //Text('Test'),
                              ElevatedButton(
                        ...
                        _buildDivider(),
                        ListTile(
                          title: const Text("Pulsa Reguler Axis 20.000"),
                          trailing: Column(
                            children: <Widget>[
                              //Text('Test'),
                              ElevatedButton(
                        ...
                        _buildDivider(),
                        ListTile(
                          title: const Text("Pulsa Reguler Axis 25.000"),
                          trailing: Column(
                            children: <Widget>[
                              //Text('Test'),
                              ElevatedButton(
                        ...
                        _buildDivider(),
                        ListTile(
                          title: const Text("Pulsa Reguler Axis 30.000"),
                          trailing: Column(
                            children: <Widget>[
                              //Text('Test'),
                              ElevatedButton(
