...
class Smart extends StatefulWidget {
  ...
  @override
  State<Smart> createState() => _SmartStateState();
}

class _SmartStateState extends State<Smart> {
                ...
                children: <Widget>[
                  Card(
                    ...
                    child: Column(
                      children: <Widget>[
                        ListTile(
                          title: const Text("Pulsa Reguler Smart 1.000"),
                          trailing: Column(
                            children: <Widget>[
                              //Text('Test'),
                              ElevatedButton(
                        ...
                        _buildDivider(),
                        ListTile(
                          title: const Text("Pulsa Reguler Smart 2.000"),
                          trailing: Column(
                            children: <Widget>[
                              //Text('Test'),
                              ElevatedButton(
                        ...
                        _buildDivider(),
                        ListTile(
                          title: const Text("Pulsa Reguler Smart 3.000"),
                          trailing: Column(
                            children: <Widget>[
                              //Text('Test'),
                              ElevatedButton(
                        ...
                        _buildDivider(),
                        ListTile(
                          title: const Text("Pulsa Reguler Smart 4.000"),
                          trailing: Column(
                            children: <Widget>[
                              //Text('Test'),
                              ElevatedButton(
                        ...
                        _buildDivider(),
                        ListTile(
                          title: const Text("Pulsa Reguler Smart 5.000"),
                          trailing: Column(
                            children: <Widget>[
                              //Text('Test'),
                              ElevatedButton(
                        ...
                        _buildDivider(),
                        ListTile(
                          title: const Text("Pulsa Reguler Smart 10.000"),
                          trailing: Column(
                            children: <Widget>[
                              //Text('Test'),
                              ElevatedButton(
                        ...
                        _buildDivider(),
                        ListTile(
                          title: const Text("Pulsa Reguler Smart 15.000"),
                          trailing: Column(
                            children: <Widget>[
                              //Text('Test'),
                              ElevatedButton(
                        ...
                        _buildDivider(),
                        ListTile(
                          title: const Text("Pulsa Reguler Smart 20.000"),
                          trailing: Column(
                            children: <Widget>[
                              //Text('Test'),
                              ElevatedButton(
                        ...
                        _buildDivider(),
                        ListTile(
                          title: const Text("Pulsa Reguler Smart 25.000"),
                          trailing: Column(
                            children: <Widget>[
                              //Text('Test'),
                              ElevatedButton(
                        ...
                        _buildDivider(),
                        ListTile(
                          title: const Text("Pulsa Reguler Smart 30.000"),
                          trailing: Column(
                            children: <Widget>[
                              //Text('Test'),
                              ElevatedButton(
