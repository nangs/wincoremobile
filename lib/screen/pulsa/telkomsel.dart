...
class Telkom extends StatefulWidget {
  const Telkom({Key? key}) : super(key: key);

  @override
  State<Telkom> createState() => _TelkomStateState();
}

class _TelkomStateState extends State<Telkom> {
                ...
                children: <Widget>[
                  Card(
                    ...
                    child: Column(
                      children: <Widget>[
                        ListTile(
                          title: const Text("Pulsa Reguler Telkomsel 1.000"),
                          trailing: Column(
                            children: <Widget>[
                              //Text('Test'),
                              ElevatedButton(
                        ...
                        _buildDivider(),
                        ListTile(
                          title: const Text("Pulsa Reguler Telkomsel 2.000"),
                          trailing: Column(
                            children: <Widget>[
                              //Text('Test'),
                              ElevatedButton(
                        ...
                        _buildDivider(),
                        ListTile(
                          title: const Text("Pulsa Reguler Telkomsel 3.000"),
                          trailing: Column(
                            children: <Widget>[
                              //Text('Test'),
                              ElevatedButton(
                        ...
                        _buildDivider(),
                        ListTile(
                          title: const Text("Pulsa Reguler Telkomsel 4.000"),
                          trailing: Column(
                            children: <Widget>[
                              //Text('Test'),
                              ElevatedButton(
                        ...
                        _buildDivider(),
                        ListTile(
                          title: const Text("Pulsa Reguler Telkomsel 5.000"),
                          trailing: Column(
                            children: <Widget>[
                              //Text('Test'),
                              ElevatedButton(
                        ...
                        _buildDivider(),
                        ListTile(
                          title: const Text("Pulsa Reguler Telkomsel 10.000"),
                          trailing: Column(
                            children: <Widget>[
                              //Text('Test'),
                              ElevatedButton(
                        ...
                        _buildDivider(),
                        ListTile(
                          title: const Text("Pulsa Reguler Telkomsel 15.000"),
                          trailing: Column(
                            children: <Widget>[
                              //Text('Test'),
                              ElevatedButton(
                        ...
                        _buildDivider(),
                        ListTile(
                          title: const Text("Pulsa Reguler Telkomsel 20.000"),
                          trailing: Column(
                            children: <Widget>[
                              //Text('Test'),
                              ElevatedButton(
                        ...
                        _buildDivider(),
                        ListTile(
                          title: const Text("Pulsa Reguler Telkomsel 25.000"),
                          trailing: Column(
                            children: <Widget>[
                              //Text('Test'),
                              ElevatedButton(
                        ...
                        _buildDivider(),
                        ListTile(
                          title: const Text("Pulsa Reguler Telkomsel 30.000"),
                          trailing: Column(
                            children: <Widget>[
                              //Text('Test'),
                              ElevatedButton(
