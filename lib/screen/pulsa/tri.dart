...
class Tri extends StatefulWidget {
  const Tri({Key? key}) : super(key: key);

  @override
  State<Tri> createState() => _TriStateState();
}

class _TriStateState extends State<Tri> {
                ...
                children: <Widget>[
                  Card(
                    ...
                    child: Column(
                      children: <Widget>[
                        ListTile(
                          title: const Text("Pulsa Reguler Tri 1.000"),
                          trailing: Column(
                            children: <Widget>[
                              //Text('Test'),
                              ElevatedButton(
                        ...
                        _buildDivider(),
                        ListTile(
                          title: const Text("Pulsa Reguler Tri 2.000"),
                          trailing: Column(
                            children: <Widget>[
                              //Text('Test'),
                              ElevatedButton(
                        ...
                        _buildDivider(),
                        ListTile(
                          title: const Text("Pulsa Reguler Tri 3.000"),
                          trailing: Column(
                            children: <Widget>[
                              //Text('Test'),
                              ElevatedButton(
                        ...
                        _buildDivider(),
                        ListTile(
                          title: const Text("Pulsa Reguler Tri 4.000"),
                          trailing: Column(
                            children: <Widget>[
                              //Text('Test'),
                              ElevatedButton(
                        ...
                        _buildDivider(),
                        ListTile(
                          title: const Text("Pulsa Reguler Tri 5.000"),
                          trailing: Column(
                            children: <Widget>[
                              //Text('Test'),
                              ElevatedButton(
                        ...
                        _buildDivider(),
                        ListTile(
                          title: const Text("Pulsa Reguler Tri 10.000"),
                          trailing: Column(
                            children: <Widget>[
                              //Text('Test'),
                              ElevatedButton(
                        ...
                        _buildDivider(),
                        ListTile(
                          title: const Text("Pulsa Reguler Tri 15.000"),
                          trailing: Column(
                            children: <Widget>[
                              //Text('Test'),
                              ElevatedButton(
                        ...
                        _buildDivider(),
                        ListTile(
                          title: const Text("Pulsa Reguler Tri 20.000"),
                          trailing: Column(
                            children: <Widget>[
                              //Text('Test'),
                              ElevatedButton(
                        ...
                        _buildDivider(),
                        ListTile(
                          title: const Text("Pulsa Reguler Tri 25.000"),
                          trailing: Column(
                            children: <Widget>[
                              //Text('Test'),
                              ElevatedButton(
                        ...
                        _buildDivider(),
                        ListTile(
                          title: const Text("Pulsa Reguler Tri 30.000"),
                          trailing: Column(
                            children: <Widget>[
                              //Text('Test'),
                              ElevatedButton(
